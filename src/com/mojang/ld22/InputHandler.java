...
public class InputHandler implements KeyListener {
	...
	private void toggle(KeyEvent ke, boolean pressed) {
		Game game = DeadMenu.getGame(); // References "Game" from a core class
		if (ke.getKeyCode() == KeyEvent.VK_ESCAPE) { game.setMenu(new TitleMenu()); }
		...
		if (ke.getKeyCode() == KeyEvent.VK_E) menu.toggle(pressed); //E now toggled inventory - SpaceByte
