...
public class Game extends Canvas implements Runnable {
	...
	private void renderGui() {
		...
		//Renders In Game Minimods version detection
		String FPSCounter = "FPS: " + frameCount;
		Font.draw("Minimods " + Core.getModdedClientVersion(), screen, 0, screen.h - 200, Color.get(0, 111, 111, 111), false);
		Font.draw("FPS: " + frameCount, screen, screen.w - (FPSCounter.length() * 8), screen.h - 200, Color.get(0, 111, 111, 111));
		for (int i = 0; i < 10; i++) {
			if (i < player.health)
