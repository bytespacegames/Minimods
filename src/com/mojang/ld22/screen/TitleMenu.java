...
public class TitleMenu extends Menu {
	...
	private static final String[] options = { "Start game", "Controls", "About"}; // Options that are on the main menu, each seperated by a comma.
	...
	public void render(Screen screen) {
		...
		int titleColor = Color.get(0, 693, 691, 698); //Colors of the title
		...
		Font.draw("Minimods " + Core.getModdedClientVersion(), screen, screen.w - 120, screen.h - 8, Color.get(0, 111, 111, 111)); // Draw the current Minimods version on screen
	}
}