...
public class DeadMenu extends Menu {
	...
	public static Game getGame() { // Returns Game to be able to be accessed outside of menus
		return game;
	}
	...
	public void render(Screen screen) {
		...
		Font.draw(timeString + " " + ms + "ms", screen, (2 + 5) * 8, 5 * 8, Color.get(-1, 550, 550, 550));// Draws the current time next to "Time:"
