...
public class Font {
	...
	public static void draw(String msg, Screen screen, int x, int y, int col) {
		draw(msg, screen, x, y, col, false); //Redirects the method to the draw method containing possible lowercase automatically checking lowercase off
	}
	
	//Minimods Lowercase text mod
	public static void draw (String msg, Screen screen, int x, int y, int col, boolean isLowerCase) {
		if (isLowerCase == true) {
			msg = msg; // Practically does nothing, just sets the message to the message - SpaceByte
		} else {
